...
function editarCliente(id) {
  ...
  const novaDataNascimento = prompt("Editar Data de Nascimento", cliente.dataNascimento);
...
searchInput.addEventListener("input", (e) => {
  ...
  const filtrados = clientes.filter((cliente) => cliente.cpf.includes(valorBusca));
